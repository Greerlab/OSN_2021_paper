...
for (i in 1:20) {
  ...
  jpeg(paste0("/Users/plg/Dropbox (UMass Medical School)/OB2_slideseq/OR_plots/Silde",i,"_OR_distribution_mito.jpeg"), width = w, height = h, res = 300, units = "in")
...
jpeg(paste0("/Users/plg/Dropbox (UMass Medical School)/OB2_slideseq/OR_plots/OR_distribution.jpeg"), width = 25, height = 13, res = 150, units = "in")
